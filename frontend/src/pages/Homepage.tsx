...
const HomePage: React.FC = () => {
    ...
    const { createSession, sessionCode, clearSession, joinSession } = useSessionstore();
    ...
    const handleCreateSession = async () => {
        await createSession(difficulty);
    };
    ...
    const handleJoinSession = async () => {
        if (joinCode) {
            ...
            if (data.status === "ACTIVE") {
                navigate(`/battle/${data.sessionId}`);
            }
        };
    }
        const clearUser = () => {
                    ...
                    <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl">
                        ...
                        <div className="flex space-x-2 mb-8 bg-white/5 p-1 rounded-lg">
                            <button
                                ...
                                className={`flex-1 py-3 px-4 rounded-lg font-semibold transition ${activeTab === 'create'
                            ...
                            <button
                                ...
                                className={`flex-1 py-3 px-4 rounded-lg font-semibold transition ${activeTab === 'join'
                                    ? 'bg-gradient-to-r from-purple-500 to-pink-500 text-white'
                                    : 'text-gray-400 hover:text-white'
                                    }`}
                            >
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-3 gap-3">
                                        <button
                                            ...
                                            className={`py-3 rounded-lg font-semibold transition ${difficulty === 'easy'
                                        ...
                                        <button
                                            ...
                                            className={`py-3 rounded-lg font-semibold transition ${difficulty === 'medium'
                                        ...
                                        <button
                                            ...
                                            className={`py-3 rounded-lg font-semibold transition ${difficulty === 'hard'
                        ...
                        {activeTab === 'join' && (
                            <div className="space-y-6">
                                ...
                                <button
                                    ...
                                    className={`w-full py-4 rounded-lg font-bold text-lg transition transform ${joinCode.length === 6
